...
(`/v1/messages`, `/api/chat`, `/api/generate`, `/api/embed`, `/api/tags`,
`/api/show`, `/api/ps`, `/api/version`), заблокированные admin routes попадают в
`/api/admin`, прочие native Ollama routes — в `/api/other`.
